...
class StoryListAdapter(private val context: Context, private val storyList: List<Story>) : RecyclerView.Adapter<StoryListAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var tv: TextView = itemView.findViewById<View>(R.id.rowStoryListText) as TextView
        var imageView: ImageView = itemView.findViewById<View>(R.id.rowStoryListImage) as ImageView
